...
alert("The average amount of orders done per day is " + avgOrd + ". You asked how many on average are processed in " + reqDay + " days. This is an average of " + reqAvgOrd + " in total. The average amount of orders per weeks would be " + reqAvgWk + " orders. The average amount of orders in months is " + reqAvgMth + " orders.");
