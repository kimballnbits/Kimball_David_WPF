...
// create variable for total cost based on amount of cats
...
alert("I spend $" + totalAmt + " each week per cat. That is $" + totCats + " for " + noCats + " cats. That is equal to $" + calcWks + " for "+ noWks + " weeks for " + noCats + " cats.");
